...
@section('content')
    <div class="row">
        {!!Form::model($data, ['route' => ['comic.update', $data->id], 'method' => 'PUT'])!!}
        <div class="col-md-8">
            <h3>批次修改</h3>
            {{Form::hidden('series_id', null, ['class' => 'form-control'])}}

            {{Form::label('series_name', 'Series 書名:')}}
        ...
        <div class="col-md-4">
            <div class="well" style="margin-top: 20px;">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {!!Html::linkRoute('comic.index', '取消', array($data->id), array('class' => 'btn btn-danger btn-block'))!!}
                    </div>
                    <div class="col-sm-6">
