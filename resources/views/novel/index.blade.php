...
@section('content')
    <div class="row">
        <div class="col-md-offset-6 col-md-3">
            <a href="{{route('novel.draft')}}" class="btn btn-sm btn-block btn-info btn-h3-spacing">顯示草稿列表</a>
        </div>
        <div class="col-md-3">
                {!!Form::open(['route' => 'novel.search', 'method' => 'POST'])!!}
            ...
            <table class="table">
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('novel.edit', $item->id)}}" class="btn btn-sm btn-block btn-default btn-h3-spacing">修改文字</a>
